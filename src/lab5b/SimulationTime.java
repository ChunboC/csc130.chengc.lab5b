 ...
 * <p>
 * <b>Description:</b><br>
 * A class with static methods for converting time between milliseconds and
 * minutes or seconds.<br>
 * It also contains a method <i>timeTillNext</i> for calculating the time an
 * event will occur based on a mean arrival time
 * 
 * @author Graham, F
 */
...
public class SimulationTime {
	...
	/*
	 * public SimulationTime() { startTime = System.currentTimeMillis(); }
	 */
	/**
